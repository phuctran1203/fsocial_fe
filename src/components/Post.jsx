...
export default function Post({ post, openModal }) {
	...
	return (
		<div className="rounded ct-shadow-y py-5 space-y-3">
			<div className="flex items-center justify-between px-4">
				<div className="flex space-x-2">
					<Link to="">
						<img src={`./temp/${post.avatar}`} alt="avatar" className="size-12 rounded-full" />
					</Link>
			...
			<div className="space-y-2">
				...
				{/* assets post */}
				<div className="">
					{post.image && <img src={`./temp/${post.image}`} alt="Bài đăng" className="w-full max-h-screen" />}
				</div>
			</div>
			...
			<div className="flex justify-between px-4">
				...
				{/* comment button */}
				<div className="flex items-center gap-2 cursor-pointer" onClick={() => openModal(post)}>
