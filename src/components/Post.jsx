		...
		<div className={`${className} transition`}>
			...
			<div className="px-4 sm:py-4 py-3  flex justify-between">
				...
				<div
					...
					onClick={handleLike}
				>
					<svg className="sm:h-[22px] h-[20px]" viewBox="0 0 25 22" fill="none">
						{/* stroke */}
						<path
							className={
								liked
									? "fill-primary stroke-primary"
									: "fill-primary-text stroke-primary-text"
							}
				...
				>
					<svg className="sm:h-[22px] h-[20px]" viewBox="0 0 22 22" fill="none">
						<path
				...
				<div className="flex items-center sm:gap-2 gap-1 cursor-pointer">
					<svg className="h-[18px]" viewBox="0 0 24 17" fill="none">
						<path
				...
				<div className="flex items-center gap-2 cursor-pointer">
					<svg className="sm:h-[22px] h-[20px]" viewBox="0 0 19 22" fill="none">
						<path
							className="stroke-primary-text"
