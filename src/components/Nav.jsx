...
export default function Nav() {
  ...
  return (
    <nav
      className={cn(
        "z-10 bg-background flex-shrink-0 border-0 transition",
        "sm:border-r sm:border-t-0 sm:static sm:flex sm:flex-col sm:justify-between sm:h-screen sm:py-6 fixed bottom-0 w-full border-t",
        !isNotificationSlide
          ? "sm:w-[210px] md:w-[260px]"
          : "sm:w-[76px] lg:w-[260px]",
