...
import { CommentNoti, Glyph, HeartNoti } from "./Icon";
...
const data = [
	...
	{ id: 6, type: "likePost", image: "user_2.png", name: "Phương Nam", time: "2025-01-07 10:22:19", read: true },
	{ id: 7, type: "likePost", image: "user_2.png", name: "Phương Nam", time: "2024-02-07 10:22:19", read: true },
	{ id: 8, type: "likePost", image: "user_2.png", name: "Phương Nam", time: "2024-02-07 10:22:19", read: true },
...
export default function Notification() {
	...
	return (
		<div className="pt-6 pb-2 ps-4 pe-5 h-screen overflow-y-auto lg:block hidden space-y-4 bg-[--background-clr] w-[340px] border-l-[1px] border-[--gray-extra-light-clr]">
			<div className="flex justify-between px-4">
				<div className="flex items-center gap-5">
					<div className="relative">
						<svg className="size-[28px]" viewBox="0 0 26 26" fill="none">
							<path
