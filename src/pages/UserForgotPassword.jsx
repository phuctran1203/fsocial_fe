...
export default function UserForgotPassword() {
  ...
  return (
    <div className="flex flex-grow bg-background">
      <div className="flex flex-grow mx-auto md:space-y-5 space-y-4 lg:maxlg:w-[min(85%,1440px)] md:h-fit h-screen relative bg-background xl:px-20 lg:px-12 lg:my-6 md:px-4 py-8 rounded-md-w-[560px] my-auto">
            ...
            >
              ...
              >
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    Kiểm tra email để nhận mã xác minh gồm 4 số và nhập vào ô
                    bên dưới
                  </p>
                  <EnterOTPCode
                    OTPValue={OTPValue}
