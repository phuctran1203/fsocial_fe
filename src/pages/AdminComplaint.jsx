		...
		<div className="pb-1 bg-background rounded-lg flex-grow border shadow flex flex-col gap-3">
			<div className="px-4 pt-4">
				...
				<p className="fs-sm text-gray">
					Quản lý báo cáo vi phạm người dùng, bài viết
				</p>
			</div>
			...
			<Table loading={loading} headers={headers}>
				...
				{filteredData.map((item, index) => (
					...
					>
						...
						<td className="px-2">
							<p className="pt-1 leading-5 fs-xs font-medium">
								{combineIntoDisplayName(item.firstName, item.lastName)}
							</p>
						...
						<td className="px-2 text-primary">
							<Link
								to={item.profileId}
								className="fs-xs font-medium hover:underline"
							>
								{item.profileId}
							</Link>
						</td>
