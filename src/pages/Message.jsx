...
import { ArrowLeftIcon, SearchIcon, SendIcon, SmileIcon } from "../components/Icon";
...
export default function Message() {
	...
	return (
		<div className="flex-grow bg-[--background-clr] overflow-hidden">
			<div className={`flex h-screen`}>
				{/* Danh sách hội thoại */}
				<div
					className="
					flex flex-col border-r pt-4 gap-4 h-screen
					sm:w-2/5 sm:min-w-[300px] sm:max-w-[350px]
					w-full"
				>
